...
function CreateNote(NoteName, Sharp){
    if(Sharp == false){
        ...
        Notes[NoteName].position = Vector2.new(LastNotePosition.x + Notes[NoteName].size.x, 0.75)
        ...
        Notes[NoteName].position = Vector2.new(Notes[NoteName.replace("#", "")].position.x + Notes[NoteName].size.x, 0.73)
